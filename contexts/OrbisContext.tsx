...
export const OrbisProvider = ({ children }: any) => {
    let orbis = new Orbis();
    const GROUP_ID = "kjzl6cwe1jw146jswj96iex6f4dar4r4njbh7vixoix0r4mymykli4eozn466rk"
    const CHANNEL_ID = "kjzl6cwe1jw1483tqcvmw17jpaimsxjctmjcdd3zy6ddxnsotwcgsrlyduvci6l"
