...
export default function NFTCard({nft}: {
    ...
    return (
        <div className="card card-image-cover relative bg-amber-50">
            ...
            <div style={{minWidth: 384}} onClick={() => window.open(`https://ipfs.io/ipfs/${nft.metadata.animation_url}${nft.metadata.type === "visualizer" ? "/nft.html": `https://${nft.metadata.image}.ipfs.nftstorage.link`}`)}
